...
class TextSprite(pygame.sprite.Sprite):
    def __init__(self, text, font_size, font_color, x, y, screen_width, screen_height):
        ...
        self.velocity = pygame.Vector2(3, 3)  # Fixed velocity
...
def draw_window():
    ...
    for sprite in all_sprites:
        if sprite.draw_circle:
            ...
            sprite.draw_circle = False  # Reset the flag
    pygame.display.flip()
            ...
            if event.type == pygame.QUIT:
                ...
                for sprite in all_sprites:
                    if sprite.rect.collidepoint(mouse_position):
                        sprite.draw_circle = True  # Set the flag to draw circle
